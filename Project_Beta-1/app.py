...
def dashboard():
    ...
    return render_template('user/user_dashboard.html', user=user, stats=stats, recent=recent)
...
def complaint_new():
    ...
    if request.method == 'POST':
        ...
        if not title or not description or not category:
            flash('All fields are required.', 'danger')
            return render_template('user/user_complaint_new.html', categories=CATEGORIES)
